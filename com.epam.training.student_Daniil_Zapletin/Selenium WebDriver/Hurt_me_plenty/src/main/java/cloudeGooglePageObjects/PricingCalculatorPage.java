...
import static cloudeGooglePageObjects.Constants.HomePageConstants.EXPLICIT_WAIT;
import static cloudeGooglePageObjects.Constants.PricingCalculatorPageConstants.*;
...
public class PricingCalculatorPage {
    ...
    @FindBy(xpath = RESULT_PROVISIONING_MODEL_VALUE)
    private WebElement resultProvisioningModel;
    @FindBy(xpath = RESULT_INSTANCE_TYPE)
    private WebElement resultInstanceType;
    @FindBy(xpath = RESULT_REGION)
    private WebElement resultRegion;
    @FindBy(xpath = RESULT_LOCAL_SSD)
    private WebElement resultLocalSSD;
    @FindBy(xpath = RESULT_COMMITMENT_TERM)
    ...
    public String getProvisioningModel(){
        return trimAndReplaceRegex(resultProvisioningModel, "Provisioning model: ");
    }

    public String getInstanceType(){
        return trimAndReplaceRegex(resultInstanceType, "Instance type: ")
                .replaceAll("Committed Use Discount applied", "")
                .trim();
    }

    public String getRegion(){
        return trimAndReplaceRegex(resultRegion, "Region: ");
    }

    public String getLocalSSD(){
        return trimAndReplaceRegex(resultLocalSSD, "Local SSD: ")
                .replaceAll("Committed Use Discount applied", "")
                .trim();
    }

    public String getCommitmentTerm(){
        return trimAndReplaceRegex(resultCommitmentTerm, "Commitment term: ");
    }
